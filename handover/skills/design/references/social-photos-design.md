...
Design social media images via HTML/CSS rendering + screenshot export. Orchestrates `ui-ux-pro-max`, `brand`, `design-system-tokens`, and `chrome-devtools` skills.
...
2. **`/ckm:design-system-tokens`** — Get design tokens (spacing, typography scale, color palette)
...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    /* Design tokens from brand/design-system-tokens */
  </style>
</head>
<body>
  <div class="canvas">
