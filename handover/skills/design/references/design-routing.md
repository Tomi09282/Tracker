...
| design-system-tokens | Token architecture, specs | SKILL.md + 7 references + 2 scripts |
...
| "How do I create a token for X?" | design-system-tokens |
| "How do I build a button component?" | ui-styling |
| "Is this on-brand?" | brand |
| "Should I use a CSS variable here?" | design-system-tokens |
...
2. design-system-tokens → Create tokens
...
2. design-system-tokens → Formalize tokens
...
```
1. design-system-tokens → Reference specs
...
**Tokens:**
```bash
node .claude/skills/design-system-tokens/scripts/generate-tokens.cjs -c tokens.json
node .claude/skills/design-system-tokens/scripts/validate-tokens.cjs -d src/
```
...
Use **brand + design-system-tokens + ui-styling** when:
...
Use **icon-design + design-system-tokens** when:
- Custom icon set matching design tokens and component specs

Use **brand + design-system-tokens** when:
- Defining design language without implementation

Use **design-system-tokens + ui-styling** when:
